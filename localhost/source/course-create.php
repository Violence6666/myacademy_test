...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $course_query = "INSERT INTO courses (course_title, course_brief, course_description, difficulty_lvl, author) 
                     VALUES (:course_title, :course_brief, :course_description, :difficulty_lvl, :author_id)";
