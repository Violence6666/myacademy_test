...
$dbname = 'myacademy'; // имя базы данных
$username = 'root'; // имя пользователя базы данных
$password = ''; // пароль для подключения к базе данных

// Подключение к базе данных с использованием объекта PDO
try {
    ...
    // Если произошла ошибка при подключении к базе данных, выводим сообщение об ошибке
        ...
        <table class="admin-tbl">
            ...
            if ($result->rowCount() > 0) {
                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><button class='button-box' onclick='editUser(this, {$row['id_user']})'>Редактировать</button><a onclick='return confirmDelete()' href='?delete_user={$row['id_user']}'><button class='button-box1'>Удалить</button></a></td>";
                    echo "</tr>";
                }
            } else {
